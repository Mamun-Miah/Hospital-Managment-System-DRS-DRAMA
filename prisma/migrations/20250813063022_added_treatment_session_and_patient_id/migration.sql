/*
  ...
  - Added the required column `patient_id` to the `PrescriptionTreatmentItem` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `prescriptiontreatmentitem` ADD COLUMN `patient_id` INTEGER NOT NULL,
    ADD COLUMN `session_number` INTEGER NULL;
