...
-- AlterTable
ALTER TABLE `invoice` MODIFY `payment_method` ENUM('Partial', 'Full', 'Due') NULL,
    MODIFY `payment_type` ENUM('Bkash', 'Cash') NULL,
    MODIFY `invoice_creation_date` DATETIME(3) NULL DEFAULT CURRENT_TIMESTAMP(3);
