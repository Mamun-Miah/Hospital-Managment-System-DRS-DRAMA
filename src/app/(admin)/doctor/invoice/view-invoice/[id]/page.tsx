          ...
          <div className="sm:flex items-center justify-between">
            <div>
              ...
              <ul className="mb-[7px]">
                <li className="mb-[7px] text-md">
                  Invoice Number: <span className="text-black dark:text-white">{invoice.invoice_number}</span>
                </li>
                <li className="mb-[7px] text-md">
                  Invoice Date: <span className="text-black dark:text-white">{formattedDate(invoice.invoice_creation_date)}</span>
                </li>
              </ul>
            </div>
            ...
            <div className="mt-[20px] sm:mt-0">
              <ul className="mb-[7px]">
                ...
                <li className="mb-[7px] text-md">
                  Patient Name: <span className="text-black dark:text-white">{invoice.patient?.patient_name}</span>
                </li>
                <li className="mb-[7px] text-md">
                  Previous Session: <span className="text-black dark:text-white">{formattedDate(invoice.invoice_creation_date)}</span>
                </li>
                <li className="mb-[7px] text-md">
            ...
            <table className="w-full">
              ...
              <tbody className="text-gray-500 dark:text-white">
                ...
                <tr className="mt-5 font-semibold text-black">
                  ...
                  <td className="p-3 pl-6">Tk. {totalTreatmentCost}</td>
                </tr>
                ...
                <tr className="mt-5 font-semibold text-black">
                  ...
                  <td className="p-3 pl-6">
                    Tk.{" "}
                    {totalTreatmentCost + invoice.doctor_fee + invoice.previous_due}
                  </td>
                </tr>
                ...
                <tr className="mt-5 font-semibold text-black">
                  <td className="p-3 pl-6 flex gap-3">
                    ...
                    <div className="text-sm">
                      Payment Method: <span>{invoice.payment_method}</span>
                    </div>
                  </td>
                  <td className="p-3 pl-6">
