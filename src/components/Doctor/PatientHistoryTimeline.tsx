    ...
    return (
        <div className=" rounded-md mb-2">
            <button
                ...
                className="w-full flex justify-between items-center px-1.5 py-1 bg-gray-100 dark:bg-gray-800 font-semibold"
            >
                {title}
                <span>{open ? "▲" : "▼"}</span>
            </button>
            {open && (
                <div
                    className="p-2 text-sm bg-white dark:bg-[#0c1427]"
...
const DateAccordion = ({ title, children, defaultOpen = false }: DateAccordionProps) => {
    ...
    return (
        <div className="mb-2">
            <button
                onClick={() => setIsOpen(!isOpen)}
                className="w-full flex justify-between items-center px-3 py-2 text-left font-medium text-sm bg-orange-100 dark:bg-gray-800 rounded-md shadow-sm"
            >
                {title}
            ...
            >
                <div className="px-3 py-2 bg-white dark:bg-[#0c1427] rounded-b-md border border-t-0 border-gray-200 dark:border-gray-700 text-sm">
                    {children}
                </div>
            </div>
        </div>
                        ...
                        <div className="mt-4">
                            <div className='flex justify-left items-center'>
                                <button
                                    ...
                                    disabled={loading}
                                    className="font-medium inline-block transition-all rounded-sm text-sm py-[4px] mb-5 px-[7px] bg-[#8F03E4] text-white hover:bg-green-700"
                                >
                                    Weight History
                                </button>
                            </div>
