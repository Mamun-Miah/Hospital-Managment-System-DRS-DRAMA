...
//             <button
//                 onClick={() => setIsOpen(!isOpen)}
//                 className="w-full flex justify-between items-center px-3 py-2 text-left font-medium text-sm bg-gray-100 dark:bg-gray-800 rounded-md shadow-sm"
//             >
//                 {title}
                        ...
                        <div className="mt-4">
                            <div className='flex justify-left items-center'>
                                <button
                                    ...
                                    disabled={loading}
                                    className="font-medium inline-block transition-all rounded-sm text-sm py-[4px] px-[7px] bg-[#8F03E4] text-white hover:bg-green-700"
                                >
                                    Weight History
                                </button>
                            </div>
